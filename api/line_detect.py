...
def checkLineCross(boundary_line, trajectory_line):
    ...
    if intersect == True:
        ...
        if angle<180:
            boundary_line.count1 -= 1 #exit line minus one
        else:
            boundary_line.count1 += 1 #enter line plus one
...
areas = [
    ...
    area([ [100,100], [500,180], [700,500], [300,300], [100,360] ])
]
...
def main():
    ...
    prev_mouse_pos = [0, 0] #set to bbox entry into frame
